...
public class AvalicaoSV extends JPanel {
	...
	public AvalicaoSV(int newIndex, List<Grupo> listaGrupos, String velhoNome, IServidor servidor) throws BancoException {
		setLayout(null);
		setSize(271, 547);
		this.index = newIndex;
		...
		txtEscola.setBounds(69, 39, 186, 22);
		add(txtEscola);
		txtEscola.setEditable(false);

		txtSerie = new TextField();
		txtSerie.setText("                            ");
		txtSerie.setBounds(69, 67, 186, 22);
		add(txtSerie);
		...
		lblNewLabel.setBounds(10, 276, 86, 14);
		add(lblNewLabel);

		JLabel lblNewLabel_1 = new JLabel("Criatividade");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 15));
		lblNewLabel_1.setBounds(10, 202, 73, 14);
		add(lblNewLabel_1);
		...
		cbNota1.addItem(0.3);
		cbNota1.addItem(0.4);
		cbNota1.setBounds(210, 108, 46, 20);
		add(cbNota1);
		...
		cbNota2.addItem(0.3);
		cbNota2.addItem(0.4);
		cbNota2.setBounds(210, 139, 46, 20);
		add(cbNota2);
		...
		cbNota3.addItem(0.3);
		cbNota3.addItem(0.4);
		cbNota3.setBounds(210, 170, 46, 20);
		add(cbNota3);
		...
		lblDominoDoConteudo.setBounds(10, 109, 145, 14);
		...
		txtDesafio.setBounds(70, 11, 186, 22);
